...
const cookieKey = "huskie_session"

var cookieConfig *Config

type HuskieSession struct {
	Key       string `json:"key"`
	Port      int    `json:"port"`
	Timestamp int64  `json:"timestamp"`
}

func SetCookie(w http.ResponseWriter, v *HuskieSession) error {
	return setCookie(w, v, cookieConfig)
}

func GetCookie(r *http.Request, v *HuskieSession) error {
